...
import com.appsnipp.modernlogin.Activities.MainExpenseActivity;
import com.appsnipp.modernlogin.R;
import com.appsnipp.modernlogin.adapters.SectionExpenseAdapter;
import com.appsnipp.modernlogin.providers.ExpensesContract.Expenses;
import com.appsnipp.modernlogin.providers.ExpensesContract.ExpensesWithCategories;
import com.appsnipp.modernlogin.utils.Utils;

import java.util.Calendar;
import java.util.Date;

public class ReportExpenseFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>,
    ...
    public void showPopupMenu(View v) {
        ...
        popup.setOnMenuItemClickListener(ReportExpenseFragment.this);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ((MainExpenseActivity) getActivity()).hideNavigationBar();
        switch (item.getItemId()) {
    ...
    private void reloadSharedPreferences() {
        ...
        String prefCurrency = sharedPref.getString(SettingsExpenseFragment.KEY_PREF_CURRENCY, "");
